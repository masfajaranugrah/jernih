...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-[#191c1d] antialiased">
      ...
      {/* TopNavBar */}
      <header className="bg-[#f8f9fa] w-full h-16 sticky top-0 z-40 shadow-sm">
        <div className="flex justify-between items-center px-6 max-w-[1280px] mx-auto w-full h-full">
          <span className="text-[#003527] font-semibold text-xl tracking-tight">Jernih Creatife</span>
          <div className="hidden md:flex items-center gap-10">
            ...
            <div className="flex items-center gap-3 text-[#003527]">
              <span className="material-symbols-outlined cursor-pointer p-2 rounded-full hover:bg-[#edeeef]">notifications</span>
              <span className="material-symbols-outlined cursor-pointer p-2 rounded-full hover:bg-[#edeeef]">shopping_cart</span>
              <span className="material-symbols-outlined cursor-pointer p-2 rounded-full bg-[#064e3b] text-[#80bea6]">person</span>
            </div>
          </div>
        </div>
      </header>

      <main className="lg:ml-64 min-h-screen p-6 md:p-12 pb-24 lg:pb-12 max-w-4xl mx-auto w-full lg:max-w-none">
        {/* Page header */}
          ...
          <div className="md:col-span-4 glass-card p-6 rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.04)] flex flex-col items-center gap-6">
            ...
            >
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-[#b0f0d6] bg-[#edeeef] shadow-inner relative">
                <Image src={avatar} alt="Foto profil" fill className="object-cover transition-transform duration-500 group-hover:scale-110" />
              </div>
