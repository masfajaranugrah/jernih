...
export default function AdminTicketDetailPage({
  ...
  return (
    <div className="h-screen bg-[#f8f9fa] text-[#191c1d] antialiased flex overflow-hidden">
      ...
      <main className="lg:ml-64 flex-1 flex flex-col h-full overflow-hidden">
        {loading || !ticket ? (
          ...
          <>
            {/* Header tiket */}
            <header className="flex flex-wrap items-center gap-3 border-b border-[#e1e3e4] bg-white px-6 py-4">
              <button
                type="button"
