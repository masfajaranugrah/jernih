      ...
      <div className="lg:ml-64 min-h-screen flex flex-col pb-24 lg:pb-0">
        ...
        <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-[#e1e3e4] bg-white/90 px-6 shadow-sm backdrop-blur">
          <div className="flex items-center gap-3">
            <span className="material-symbols-outlined text-[#003527]">tune</span>
            <h1 className="text-[#003527] font-bold text-lg">Tampilan Homepage</h1>
          </div>
          {/* Status indicator realtime */}
          <div className="flex items-center gap-2 text-xs font-semibold text-[#707974]">
            {savingKey ? (
              <>
                <span className="material-symbols-outlined text-sm spin text-[#064e3b]">autorenew</span>
                <span className="text-[#064e3b]">Menyimpan...</span>
              </>
            ) : error ? (
              <>
                <span className="material-symbols-outlined text-sm text-[#ba1a1a]">error</span>
                <span className="text-[#ba1a1a]">Gagal disimpan</span>
              </>
            ) : (
              <>
