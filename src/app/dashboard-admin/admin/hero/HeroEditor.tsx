  ...
  <div className="min-h-screen bg-[#f8f9fa]">
   ...
   <div className="lg:ml-64 min-h-screen flex flex-col pb-24 lg:pb-0">
    ...
    <div className="px-6 pt-6 pb-2">
     <h1 className="text-[#003527] font-bold text-2xl">Edit Hero Banner</h1>
     <p className="text-sm text-[#707974] mt-1">Kelola banner utama dan banner samping halaman home</p>
    </div>

    <main className="px-4 sm:px-6 py-6 space-y-6 w-full max-w-6xl">
