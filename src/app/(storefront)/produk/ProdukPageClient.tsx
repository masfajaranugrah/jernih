        ...
        <main className="flex-grow min-w-0">
          ...
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={openFilter}
                className="md:hidden relative flex items-center gap-1.5 rounded-lg border border-[#e1e3e4] bg-white px-3 py-2 text-xs font-semibold text-[#191c1d] hover:border-[#003527] transition-colors"
              >
      ...
      <footer className="bg-[#e7e8e9] w-full py-16 mt-8 border-t border-[#bfc9c3]">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-start gap-10">
          <div className="space-y-4 max-w-sm">
            ...
            <p className="text-[#707974] text-base">Platform belanja terpercaya dengan produk berkualitas pilihan.</p>
          </div>
          <div className="grid grid-cols-2 gap-10">
            <div className="space-y-3">
              <h4 className="font-semibold text-xs uppercase tracking-wider text-[#191c1d]">Pusat Bantuan</h4>
              <ul className="space-y-2 text-[#707974]">
                {["Contact Us", "Shipping & Returns", "Track Order"].map((item) => (
