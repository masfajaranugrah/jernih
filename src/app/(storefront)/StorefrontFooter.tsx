    ...
    <footer className="w-full bg-white">
      ...
      <section className="border-b border-neutral-100 bg-white">
        <div className="mx-auto max-w-[1280px] px-6 py-10 md:px-12 md:py-14">
          <h2 className="text-lg font-bold text-[#0F172A] mb-4">Tentang Jernih Kreatif</h2>
      ...
      <section className="border-b border-[#e2e8f0] bg-white">
        <div className="mx-auto max-w-[1280px] px-6 py-14 md:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-2 text-xl font-extrabold text-[#0F172A] md:text-2xl">Dibangun untuk transaksi yang praktis, jelas, dan mendukung pertumbuhan usaha.</h2>
          </div>
          ...
          <div className="mt-8 rounded-2xl bg-[#2563EB] px-6 py-6 text-white md:flex md:items-center md:justify-between md:gap-6">
            <div>
            ...
            <Link href="/register-mitra" className="mt-4 inline-flex rounded-xl bg-white px-5 py-2.5 text-sm font-extrabold text-[#2563EB] transition hover:bg-[#EFF6FF] md:mt-0">
              Daftar Mitra
            </Link>
          </div>
        </div>
      ...
      <section className="border-b border-[#e2e8f0] bg-white">
        <div className="mx-auto max-w-[1280px] px-6 py-12 md:px-12">
          <div className="mb-6 max-w-2xl">
            ...
            <h2 className="mt-2 text-xl font-extrabold text-[#0F172A] md:text-2xl">Prinsip layanan untuk pengalaman transaksi yang lebih aman.</h2>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="flex items-start gap-4 rounded-lg border border-[#e2e8f0] bg-white p-4">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#0F172A]">Transparan</p>
            ...
            <div className="flex items-start gap-4 rounded-lg border border-[#e2e8f0] bg-white p-4">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#0F172A]">Aman</p>
            ...
            <div className="flex items-start gap-4 rounded-lg border border-[#e2e8f0] bg-white p-4">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#0F172A]">Rekening Bersama</p>
      ...
      <div className="border-t-2 border-dashed border-[#cbd5e1]">
        <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-6 py-16 md:grid-cols-4 md:px-12 md:py-20">
          <div className="space-y-6">
            <div className="text-2xl font-extrabold tracking-tight text-[#0F172A]">Jernih Creative</div>
          ...
          <div className="space-y-6">
            <h4 className="text-sm font-bold uppercase tracking-[0.18em] text-[#0F172A]">Perusahaan</h4>
            <nav className="flex flex-col gap-3" aria-label="Footer perusahaan">
              {companyLinks.map((item) => (
                <Link key={item.label} href={item.href} className="text-base font-bold text-[#475569] transition-colors hover:text-[#0F172A]">
                  {item.label}
                </Link>
              ))}
            </nav>
          ...
          <div className="space-y-6">
            <h4 className="text-sm font-bold uppercase tracking-[0.18em] text-[#0F172A]">Legal</h4>
          ...
          <div className="space-y-6">
            <h4 className="text-sm font-bold uppercase tracking-[0.18em] text-[#0F172A]">Metode Pembayaran</h4>
