      ...
      <main className="flex-1 md:ml-64 p-6 md:p-10 max-w-[1280px] mx-auto overflow-x-hidden pb-24 md:pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            ...
            {/* Active orders */}
            <Link
              href="/dashboard-pelanggan/orders"
          ...
          <div className="md:col-span-4 bg-white rounded-xl shadow-sm border border-[#e1e3e4] p-6 flex flex-col">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/dashboard-pelanggan/addresses">
            ...
            <div className="mt-auto">
              <div className="w-full h-32 rounded-lg bg-[#e7e8e9] overflow-hidden relative">
                <Image
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuD_Y9lcnSYWz7z7lYkAwSyaFzOPR0sLqBXa7Utfc-RIKVWGKtso0i7bDoUhUTd5JbE2ev76ok5OyjpG1C1EWVmLHqrZqDwxQKq4BO2VYAeOw8utXY7GlwoAXiN7N61mZIYSgQ3qAuIt9tKoMP3uDgnEQL5w5ZIUb5vz7zMWZJkZESyOUX4fBeRiqM7TV7c1TF-KfjEmMM5wh6L6HkCJfseMS01vY56T1RUNtxOWwdNhsnCdz9o-ZB2E"
                  alt="Map Location"
                  fill
